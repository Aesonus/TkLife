...
def test_grid_one_size_more_at_end():
    ...
    actual=Autogrid((1,), 2).grid_tuples(6)
...
def test_grid_two_size():
    ...
    actual=Autogrid((2,3), 2).grid_tuples(10)
    assert tuple(actual) == expected
...
def test_grid_two_size_more_at_end():
    ...
    actual=Autogrid((2,3), 2).grid_tuples(16)
    assert tuple(actual) == expected
...
def test_grid_four_size_more_at_end():
    ...
    actual = Autogrid((2,3,4,2), 2).grid_tuples(26)
    assert tuple(actual) == expected
...
def test_grid_dicts():
    ...
    actual = Autogrid((1, ), 2).grid_dicts(4, 'ab')
    assert tuple(actual) == expected
...
def test_zip_dicts():
    ...
    actual = Autogrid((1, ), 2).zip_dicts(('elema', 'elemb', 'elemc', 'elemd'), 'ab')
    assert tuple(actual) == expected
...
def test_zip_dicts_with_kwargs():
    ...
    actual = Autogrid((1, ), 2).zip_dicts(('elema', 'elemb', 'elemc', 'elemd'), 'ab', grid_kwargs_list=(
